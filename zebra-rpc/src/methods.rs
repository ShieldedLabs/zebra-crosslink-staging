...
use zcash_protocol::consensus::{NetworkUpgrade as ZcashNetworkUpgrade, Parameters};
    ...
    SyncStatus: ChainSyncStatus + Clone + Send + Sync + 'static,
{
    ...
    async fn z_get_treestate(&self, hash_or_height: String) -> Result<GetTreestateResponse> {
        ...
        let sapling_nu = ZcashNetworkUpgrade::Sapling;
        ...
        let orchard_nu = ZcashNetworkUpgrade::Nu5;
